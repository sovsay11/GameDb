<h1 align="center">Game Db (Pokemon) Application</h1>

<!--About The Project-->
## About The Project
This application will hit the free Pokemon API for basic Pokemon data like stats and types.
...
```sh
git clone https://github.com/sovsay11/GameDb.git
```
    

## Usage
This application was created to help with looking up random stats and info about Pokemon.
